<div
                    ...
                    <div>
                        ...
                        <p class="mb-6 font-extrabold text-gray-700 lg:text-5xl text-xl  font-mono ">@currency($user->transactions->sum('pay_total') - $user->convertions->where('pay_status', 3)->sum('pay_total'))</p>
