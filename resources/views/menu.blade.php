...
<div>
                        <a href="{{route('konversi')}}"
                            ...
                            <div><img src="{{ asset('img/dashboard.png')}}" alt="" class="w-10 h-10"></div>
                            <div>Dashboard</div>
                        </a>
                    </div>
                    <div>
...
<div>
                        <a href="{{route('konversi')}}"
                            class="w-40 h-32 flex flex-col justify-center items-center hover:shadow-2xl hover:bg-blue-600 border-[2px] xl:px-[65px] xl:py-[44px] lg:px-[45px] lg:py-[24px] px-[20px] py-[10px] bg-white rounded-[35px] shadow-lg">
                            <div><img src="{{ asset('img/dustbin.png')}}" alt="" class="w-10 h-10"></div>
                            <div>Pengepul</div>
                        </a>
                    </div>
                    <div>
                        <a href="{{route('transaction')}}"
                            class="w-40 h-32 flex flex-col justify-center items-center hover:shadow-2xl hover:bg-blue-600 border-[2px] xl:px-[65px] xl:py-[44px] lg:px-[45px] lg:py-[24px] px-[20px] py-[10px] bg-white rounded-[35px] shadow-lg">
                            <div><img src="{{ asset('img/adjustments.png')}}" alt="" class="w-10 h-10"></div>
                            <div>Adjustment</div>
                        </a>
                    </div>
                    <div>
