...
<div class="container mx-auto p-5 sm:p-10 lg:p-20 bg-gradient-to-b from-[#1EF53F] to-white min-h-screen">
    <div class="flex flex-col lg:flex-col justify-end items-center ">
     ...
     <div class="md:w-1/2">
        ...
        <form>
            <div class="mb-6 ">
                <label for="email" class="block mb-2 text-lg font-medium text-white">No HP</label>
            ...
            <button type="submit"
                class="text-white bg-[#1EF53F] hover:bg-[#021f06] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Login</button>
        </form>
     </div>
    </div>
</div>
