                                    ...
                                    <div class="text-center bg-blue-600 hover:bg-blue-800 rounded-xl p-4">
                                        ...
                                        <ul class="text-sm text-white dark:text-gray-300">
                                            ...
                                            <li>
                                                ...
                                                <form action="{{ route('print_transaction') }}" target="_blank"
                                                    method="GET" class="mb-3 mt-3">
                                    ...
                                    <div class="text-center bg-blue-600 hover:bg-blue-800 rounded-xl p-4">
                                        ...
                                        <ul class="text-sm text-white dark:text-gray-300">
                                            ...
                                            <li>
                                                ...
                                                <form action="{{ route('print_convertion') }}" target="_blank"
                                                    method="GET" class="mb-3 mt-3">
                                                    <div class="flex space-x-2">
                                                        <input type="date" required
                                                            class="bg-blue-500 border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring focus:ring-indigo-200 focus:border-indigo-500"
                                    ...
                                    <div class="text-center bg-blue-600 hover:bg-blue-800 rounded-xl p-4">
                                        ...
                                        <ul class="text-sm text-white dark:text-gray-300">
                                            ...
                                            <li>
                                                ...
                                                <form action="{{ route('print_profit') }}" target="_blank" method="GET"
                                                    class="mb-3 mt-3">
                                                    <div class="flex space-x-2">
                                                        <input type="date" required
                                                            class="bg-blue-500 border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring focus:ring-indigo-200 focus:border-indigo-500"
                                    ...
                                    <div class="text-center bg-blue-600 hover:bg-blue-800 rounded-xl p-4">
                                        ...
                                        <ul class="text-sm text-white dark:text-gray-300">
                                            ...
                                            <li>
                                                ...
                                                <form action="{{ route('print_expend') }}" target="_blank" method="GET"
                                                    class="mb-3 mt-3">
                                                    <div class="flex space-x-2">
                                                        <input type="date" required
                                                            class="bg-blue-500 border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring focus:ring-indigo-200 focus:border-indigo-500"
                                    ...
                                    <div class="text-center bg-blue-600 hover:bg-blue-800 rounded-xl p-4">
                                        ...
                                        <ul class="text-sm text-white dark:text-gray-300">
                                            ...
                                            <li>
                                                ...
                                                <form action="{{ route('print_manage') }}" target="_blank" method="GET"
                                                    class="mb-3 mt-3">
                                                    <div class="flex space-x-2">
                                                        <input type="date" required
                                                            class="bg-blue-500 border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring focus:ring-indigo-200 focus:border-indigo-500"
