                                ...
                                <div>
                                    <label for="price"
                                        ...
                                        <div x-data="{ number: null }">
                                            <input type="number" name="price" x-model="number" x-on:input="number = parseFloat($event.target.value)" x-on:blur="$event.target.value = number.toLocaleString('id-ID', {minimumFractionDigits: 0, maximumFractionDigits: 0})"
