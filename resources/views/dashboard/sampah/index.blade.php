                                                    ...
                                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                        ...
                                                        <div class="px-6 py-6 lg:px-8">
                                                            ...
                                                            <form class="space-y-6"
                                                                ...
                                                                <input type="number" name="buy" id="buy"  @if($category->categoryPrices->count() > 0)value="{{$category->categoryPrices->last()->buy}}" @else value="0"
                                                                @endif
                                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                                                            required>
                                                                </div>
                                                                ...
                                                                <input type="number" name="sell" id="sell"  @if($category->categoryPrices->count() > 0) value="{{$category->categoryPrices->last()->sell}}" @else value="0" @endif
                                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                                                            required>
                                                                </div>
                                                                @if ($date)
                                                                <input type="hidden" name="created_at" value="{{$date->created_at}}">
                                                                @endif
