            ...
            <div class="relative w-full h-full max-w-md md:h-auto">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="px-6 py-6 lg:px-8">
                        ...
                        <form class="space-y-6" action="{{route('paymentpengepul')}}" method="POST">
                            @csrf
                            ...
                            <button type="submit" onclick="return confirm('Apakah Nominal Pembayaran yang anda masukkan sudah benar? Data Tidak bisa diubah setelah anda klik simpan')"
                            ...
                            <div class="text-sm font-medium text-gray-500 dark:text-gray-300">
                                    ...
                                    <th scope="row"
                                        class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap bg-gray-50 dark:text-white dark:bg-sidebar">
                                        <div>
                                            <a href="{{ route('print_transaction_collector', ['id' => $transaction->id]) }}" target="blank"
