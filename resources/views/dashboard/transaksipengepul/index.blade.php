            ...
            <div>
                ...
                {{-- <div id="authentication-modalPengepul" tabindex="-1" aria-hidden="true"
                    ...
                    <div class="relative w-full h-full max-w-md md:h-auto"> --}}
                        ...
                        <div id="authentication-modalPengepul" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                                                    ...
                                                                    <div class="flex flex-col gap-1">
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <button type="submit"
                                                                                ...
                                                                                class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-2 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Buat
                            ...
                            Disetujui
                                    ...
                                    <th scope="row"
                                        ...
                                        @else
                                            ...
                                            <!-- Modal toggle -->
                                            <button data-modal-target="authentication-modal{{ $transaction->id }}payment"
                                                data-modal-toggle="authentication-modal{{ $transaction->id }}payment"
                                                class="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                                                type="button">
                                                Pembayaran
                                            </button>
                                            <!-- Main modal -->
                                            <div id="authentication-modal{{ $transaction->id }}payment" tabindex="-1"
                                                aria-hidden="true"
                                                class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] md:h-full">
                                                <div class="relative w-full h-full max-w-md md:h-auto">
                                                    <!-- Modal content -->
                                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                        <button type="button"
                                                            class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-sidebar dark:hover:text-white"
                                                            data-modal-hide="authentication-modal{{ $transaction->id }}payment">
