...
<body class="bg-gray-200">
    ...
    <div class="container mx-auto p-4">
        <div class="table-responsive lg:w-3/4 mx-auto">
            ...
            <h2 class="text-center text-2xl font-bold mb-4">LAPORAN PENCAIRAN DANA</h2>
            <table class="mb-4">
            ...
            <table class="table-auto mb-4 w-full">
                ...
                <tbody>
                    @foreach ($withdraws as $withdraw)
                        <tr>
                            <td class="border px-4 py-2">{{ withdraw->createded_at->format('d-m-Y') }}</td>

                            <td class="border px-4 py-2">
                               
                                    Pencairan dana {{withdraw->user->name}}
                               
                            </td>
                            <td class="border px-4 py-2">
                                
                                    @currency(withdraw->pay_total)
                    ...
                    <tr>
                        ...
                        <td class="border px-4 py-2"> @currency(withdraws->sum('pay_total'))
                    </tr>
