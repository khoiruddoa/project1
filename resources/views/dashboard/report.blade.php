        ...
        <div class="bg-blue-500 text-white rounded-lg p-6">
            ...
            <div class="grid md:grid-cols-3 grid-cols-1 gap-4 ">
                ...
                <div class="text-center bg-blue-600 hover:bg-blue-800 rounded-xl p-4">
                    <div>
                        <p class="text-sm text-gray-100 mb-2">Laporan Transaksi Nasabah</p>
                    </div>
                ...
                <div class="text-center bg-blue-600 hover:bg-blue-800 rounded-xl p-4">
                    <div>
                        <p class="text-sm text-gray-100 mb-2">Laporan Pendapatan</p>
                    </div>
                    <ul class="text-sm text-white dark:text-gray-300">

                    <li>

                            <form action="{{ route('pendapatan') }}" method="GET" class="mb-3 mt-3">
                ...
                <div class="text-center bg-blue-600 hover:bg-blue-800 rounded-xl p-4">
                    <div>
                        <p class="text-sm text-gray-100 mb-2">Laporan Pencairan Dana</p>
                    </div>
                    <ul class="text-sm text-white dark:text-gray-300">

                        <li>

                            <form action="{{ route('print_withdraw') }}" target="_blank" method="GET" class="mb-3 mt-3">
                                <div class="flex space-x-2">
                                    <input type="date" required
                                        class="bg-blue-500 border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring focus:ring-indigo-200 focus:border-indigo-500"
                                        name="start_date">
                ...
                <div class="text-center bg-blue-600 hover:bg-blue-800 rounded-xl p-4">
                    <div>
                        <p class="text-sm text-gray-100 mb-2">Laporan Adjustment</p>
                    </div>
                    <ul class="text-sm text-white dark:text-gray-300">

                        <li>

                            <form action="{{ route('print_adjustment') }}" target="_blank" method="GET" class="mb-3 mt-3">
                                <div class="flex space-x-2">
                                    <input type="date" required
                                        class="bg-blue-500 border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring focus:ring-indigo-200 focus:border-indigo-500"
                                        name="start_date">
                ...
                <div class="text-center bg-blue-600 hover:bg-blue-800 rounded-xl p-4">
                    <div>
                        <p class="text-sm text-gray-100 mb-2">Laporan Ongkos Kirim</p>
                    </div>
                    <ul class="text-sm text-white dark:text-gray-300">

                        <li>

                            <form action="{{ route('print_ongkir') }}" target="_blank" method="GET" class="mb-3 mt-3">
                                <div class="flex space-x-2">
                                    <input type="date" required
                                        class="bg-blue-500 border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring focus:ring-indigo-200 focus:border-indigo-500"
                                        name="start_date">
                ...
                <div class="text-center bg-blue-600 hover:bg-blue-800 rounded-xl p-4">
                    ...
                    <ul class="text-sm text-white dark:text-gray-300">
                        ...
                        <li>
                            ...
                            <form action="{{ route('print_gold') }}" target="_blank" method="GET" class="mb-3 mt-3">
                                <div class="flex space-x-2">
                                    <input type="date" required
                                        class="bg-blue-500 border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring focus:ring-indigo-200 focus:border-indigo-500"
                                        name="start_date">
